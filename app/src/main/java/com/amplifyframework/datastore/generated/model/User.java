...
public final class User implements Model {
  ...
  public static final QueryField SCORE = field("User", "score");
  ...
  private User(String id, String name, String email, Integer score) {
    this.id = id;
    this.name = name;
    this.email = email;
    this.score = score;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), user.getId()) &&
              ...
              ObjectsCompat.equals(getScore(), user.getScore());
      }
  }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String email, Integer score) {
      super.id(id);
      super.name(name)
        .email(email)
        .score(score);
